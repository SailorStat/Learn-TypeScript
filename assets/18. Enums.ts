...
// Самый большой аргумент в пользу этого формата по сравнению с enum - он поддерживает вашу кодовую базу
//  в соответствии с состоянием JS, и когда/если перечисления добавляются в JS,
//  вы можете перейти к дополнительному синтаксису